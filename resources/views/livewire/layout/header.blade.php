<header class="w-full border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
    <!-- Utility bar -->
    <div class="bg-base-50/60 hidden border-b border-zinc-200 dark:border-zinc-800 dark:bg-zinc-800/60 md:block">
        <div
            ...
            <div class="flex items-center gap-2">
                <span>Contact:
                    <a class="text-xs font-medium text-zinc-600 hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white"
                        href="#_">
                        hello@acme.com
                    </a></span>
                <span aria-hidden class="h-3 w-px bg-zinc-300 dark:bg-zinc-700"></span>
                <a class="undefined font-medium text-zinc-600 hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white"
                    href="#_">
                    Support
                </a>
            </div>
    ...
    <div x-data="{ open: false, }" class="mx-auto max-w-7xl px-6 md:px-10 lg:px-16">
        <div class="flex h-14 items-center justify-between gap-3">
            ...
            <button
                ...
                @click="open=!open" :aria-expanded="open" aria-controls="nav-05m">
        ...
        <div id="nav-05m" :class="{ 'grid': open, 'hidden': !open }"
