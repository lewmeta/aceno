...
<div
  class="bg-linear-to-t mx-auto max-w-md rounded-xl from-zinc-50 to-zinc-100 p-8 shadow outline outline-zinc-100 dark:from-zinc-800 dark:to-zinc-900 dark:outline-zinc-800"
>
  <div class="text-center lg:text-balance">
    <h1
      class="text-xl font-semibold tracking-tight text-zinc-900 md:text-2xl lg:text-3xl dark:text-white"
    >
      Sign in
    </h1>
    <p class="mt-4 text-balance text-base text-zinc-500 dark:text-zinc-400">
      Welcome back! Fire up that password muscle memory, just like the good old
      dial-up days.
    </p>
  </div>
  <form class="mt-10 space-y-4">
    <div class="w-full">
      <div class="mb-1 flex items-baseline justify-between">
        <label for="email" class="text-sm font-medium text-zinc-500"
          >Email Address</label
        >
      </div>
    ...
    <div class="w-full">
      <div class="mb-1 flex items-baseline justify-between">
        <label for="password" class="text-sm font-medium text-zinc-500"
          >Password</label
        >
      </div>
      <div
      ...
      >
        ...
        <div class="absolute inset-y-0 right-0 flex items-center gap-2 pr-3">
          <button
            ...
            class="text-zinc-500 focus:outline-none dark:text-zinc-300"
            tabindex="-1"
