...
$logout = function (Logout $logout) {
    ...
    $this->redirect('/vendor/login', navigate: true);
};
...
<header
    ...
    <div x-data="{ open: false, user: false, dark: document.documentElement.classList.contains('dark') }" class="mx-auto max-w-7xl px-6 pl-3! md:px-10 lg:px-8">
        <div class="flex h-14 items-center justify-between gap-3">
            <div href="#_" class="inline-flex items-center gap-2">
                <span class="" @click="$dispatch('vesibar-toggle')">x</span>
